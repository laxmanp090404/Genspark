...
namespace UnderstandingOops.Services
{
    internal class CustomerService : ICustomerInteract
    {
        ...
        private Account TakeCustomerDetails()
        {
            ...
            Console.WriteLine("Please enter your phone number(without country code)");
        ...
        public void PrintAccountDetailsUsingMobile(string mobileNumber)
        {
            ...
            Console.WriteLine("No account with the given mobile number is present with us");
        }
    }
}
