...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=day4;Username=laxmanp;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Accno).HasName("pk_accounts");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_transac");
            ...
            entity.Property(e => e.Toaccno).HasColumnName("toaccno");

            entity.HasOne(d => d.FromaccnoNavigation).WithMany(p => p.TransacFromaccnoNavigations)
                .HasForeignKey(d => d.Fromaccno)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_transac_fromacc");

            entity.HasOne(d => d.ToaccnoNavigation).WithMany(p => p.TransacToaccnoNavigations)
                .HasForeignKey(d => d.Toaccno)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_transac_toacc");
        });
